...
"The Rust Programming Language",
  ...
  let indexOfBook = programmingBooks.indexOf("You Don't Know JS");
  
  if (indexOfBook !== -1) {
    alert(`El libro "You Don't Know JS" se encuentra en la estantería ${indexOfBook}.`);
  } else {
    alert("El libro 'You Don't Know JS' no se encuentra en la biblioteca de programación.");
  }