...
// Array de libros de programación
...
let userInputTitle = prompt("Ingrese un título de libro:");

if (programmingBooks.includes(userInputTitle)) {
     alert("El libro se encuentra en la biblioteca de programación.");
} else {
  alert("El libro no se encuentra en la biblioteca de programación.");
}
